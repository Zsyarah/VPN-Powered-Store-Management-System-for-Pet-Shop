            ...
            <div class="bg-white p-4 rounded-lg shadow-lg text-center"> 
                ...
                <div class="scrollbar border border-gray-400 rounded-lg p-2 overflow-y-auto max-h-40">
                    ...
                    <tbody>
                        {#each sales as sale}
                        <tr>
                            <td class="border border-gray-300 p-2">{sale.no}</td>
                            <td class="border border-gray-300 p-2">{sale.quantity}</td>
                            <td class="border border-gray-300 p-2">{sale.receipt}</td>
                            <td class="border border-gray-300 p-2">{sale.total.toFixed(2)}</td>
                        </tr>
                        {/each}
                    </tbody>
                    </table>
